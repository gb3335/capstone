...
import {
  checkPlagiarismLocal,
  setPlagiarismRawLocalShowDetails,
  setPlagiarismRawLocalHideDetails,
  createRawLocalPlagiarismReport,
  setPlagiarismGenerateReportLoading
} from "../../actions/localRawPlagiarismActions";
...
class LocalCheck extends Component {
  ...
  render() {
    ...
    if (showDetails) {
      ...
      highlightItems = (
        <div className="sourceResearch">
          {Object.entries(this.props.localRawPlagiarism.output).length !== 0 &&
          this.props.localRawPlagiarism.output.constructor !== Object ? (
            <Transition
              native
              items={!loading}
              from={{ opacity: 0 }}
                ...
                <form onSubmit={this.onSubmit}>
                  ...
                  {this.props.errors.errors ? (
                    <p className="text-danger">
                      {this.props.errors.errors.noResearchForPlagiarism}
                    </p>
                  ) : (
                    ""
                  )}
                  ...
                  this.props.localPlagiarism.globalLoading.number !== 3 ? (
                    <p>
                    ...
                    <button
                      type="submit"
                      className={
                        this.props.localRawPlagiarism.buttonDisable
